...
//        }
//
//        mutating public func setPrimaryKey(withColumns columns: Array<IndexedColumn>, onConflict: Base.Conflict?) {
//            constraints.append(.primaryKey(columns, onConflict))
//        }
//
//        mutating public func setUnique(withColumns columns: Array<IndexedColumn>, onConflict: Base.Conflict?) {
